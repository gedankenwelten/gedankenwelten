...
- **Beruf:** Partnership Manager bei [Circular Berlin](https://circular.berlin/) (Berlin Recycling Network e.V.), einer gemeinnützigen Organisation und einem Netzwerk aus Fachleuten und Organisationen, die den Wandel Berlins zur zirkulären Stadt beschleunigen.
...
| Kanal / Projekt | Link | Beschreibung |
|---|---|---|
| Circular Berlin | [circular.berlin](https://circular.berlin/) | Gemeinnütziges Netzwerk für die Kreislaufwirtschaft in Berlin — Forschung, Netzwerkaufbau, handlungsorientierte Projekte. |
| Circular Value Program | [circular.berlin](https://circular.berlin/) | Von Bendsen auf der re:publica vorgestelltes Programm: datenbasierte Tools, die versteckte Kosten linearer Modelle sichtbar machen; Arbeit mit Unternehmen und Banken an zirkulären Finanzierungsansätzen. |
| LinkedIn (Nicole Bendsen) | [linkedin.com](https://www.linkedin.com/in/nicole-bendsen-420050203/) | Persönliches Berufsprofil. |
| Circular Berlin auf LinkedIn | [linkedin.com/company/circular-berlin](https://de.linkedin.com/company/circular-berlin) | Organisationskanal mit Positionen zu Wohnungsbau, Recycling, Kreislaufwirtschaft. |
| re:publica 26 — Sprecherprofil | [re-publica.com/user/26245](https://re-publica.com/user/26245) | Offizielles Profil zum Lightning Talk. |
