---
title: "Fediverse — Die digitale Allmende"
date: 12.06.2026
description: "Allmenden tragen sich nicht von selbst: Alle profitieren, wenige tragen die Infrastruktur. Warum das offene Netz keine bessere Technik braucht, sondern zivilgesellschaftliche Power — und Schönheit."
...
Quelle A: [39C3 — Auf die Dauer hilft nur Power: Herausforderungen für dezentrale Netzwerke aus Sicht der Soziologie](https://media.ccc.de/v/39c3-auf-die-dauer-hilft-nur-power-herausforderungen-fur-dezentrale-netzwerke-aus-sicht-der-soziologie) (Marco Wähner, Dez. 2025 · [YouTube-Spiegel](https://www.youtube.com/watch?v=aJqzvwuAi88))
Quelle B: [re:publica 26 — Digitale Souveränität durch dezentrale Netzwerke? Das Beispiel Mastodon](https://www.youtube.com/watch?v=CalkPs4fQ-g) (Marco Wähner, 2026)
Quelle C: [#fediday2025 — Recht haben reicht nicht: Überlegungen zur Zukunft des Fediverse](https://tube.sekretaerbaer.net/videos/watch/cf4d3a56-da68-4978-a925-c6326a4c25c4) (Ralf Stockmann, Okt. 2025 — auf PeerTube, CC BY-SA 4.0)
...
>
> → [[DenkerVita/Marco Waehner|DenkerVita]]
...
>
> → [[DenkerVita/Ralf Stockmann|DenkerVita]]
...
[▶ 1:50](https://www.youtube.com/watch?v=aJqzvwuAi88&t=110) — Wähner beginnt mit einem Ausgangspunkt, der so simpel wie folgenreich ist: Wenn alle von dezentralen Netzwerken profitieren, ohne zur Infrastruktur beitragen zu müssen, unterliegen diese Netzwerke einer **originären Instabilität** — es sei denn, man monetarisiert sie. Das ist die alte Trittbrettfahrer-Logik der Kollektivgutforschung (Olson, Hardin, Ostrom), angewendet auf Server statt Weideland: Der Nutzen ist für alle da, die Kosten tragen wenige, und niemand kann ausgeschlossen werden.

> *„Dezentrale Netzwerke unterliegen einer sozialen Ordnung, die sich nicht ohne Weiteres technisch fixen lässt."* [▶ 2:35](https://www.youtube.com/watch?v=aJqzvwuAi88&t=155)
...
> [!success] Bestätigt — Erik Spiekermann
> Schriften für Deutsche Bahn (mit Christian Schwartz) und Audi; geboren 1947. Quelle: [Wikipedia — Erik Spiekermann](https://en.wikipedia.org/wiki/Erik_Spiekermann)

> [!success] Eingeordnet — Stockmanns Postulate sind Postulate
...
- [netzpolitik.org — „Es braucht dauerhaft zivilgesellschaftliche Power" (Interview mit Marco Wähner)](https://netzpolitik.org/2025/dezentrale-netzwerke-es-braucht-dauerhaft-zivilgesellschaftliche-power/) — vertieft die 39C3-Thesen
- [CAIS — In the Long Run, Only Power Helps](https://www.cais-research.de/en/news/in-the-long-run-only-power-helps-challenges-for-decentralized-networks-from-a-sociological-perspective/) — Institutsseite zum Vortrag
- [Wähner et al. — „Don't research us" (Publizistik 69(3))](https://link.springer.com/article/10.1007/s11616-024-00855-6) — Forschungsethik im Fediverse
- [Mastowall](https://github.com/rstockm/mastowall) · [GitHub rstockm](https://github.com/rstockm) — Stockmanns Werkzeuge (Mastowall, FediPol, Mastotags)
- [Ultraschall.fm](https://ultraschall.fm/) — Stockmanns Podcast-Produktionssoftware

*Im Vortrag erwähnt:*

- Michael Seemann — das „Umtopfen ganzer Communities" als Migrationsstrategie
- [digitalcourage.social](https://digitalcourage.social/) — Teilhabe-Modell: Mitnutzung = Mitfinanzierung
- [Fedidevs — Starter Packs für Mastodon](https://fedidevs.com/) — kuratierte Folgelisten nach Bluesky-Vorbild
...
- [FediDB — Fediverse Network Statistics](https://fedidb.org/) — Live-Tracker, belegt die „registriert ≠ aktiv"-Schere
- [The Fediverse in Numbers — Mastodon Stats 2026 (Fediview)](https://fediview.com/articles/fediverse-in-numbers-mastodon-stats-2026/) — aktuelle Aufschlüsselung inkl. MAU-Rückgang
- [Mastodon 4.5 bringt Quote-Posts (TechCrunch)](https://techcrunch.com/2025/11/06/mastodons-latest-software-update-brings-quote-posts-to-all-server-operators/) — datiert das Quote-Feature exakt
- [An Extended View on Measuring Tor AS-level Adversaries (arXiv)](https://arxiv.org/pdf/2403.08517) — empirische Grundlage für die De-Anonymisierungs-Spirale
...
> - Stockmann nennt das Outlink-Verbot von Instagram 2012 den Sündenfall; [[Zeitgeist/Martin Andree - Monopole zerstoeren unsere Demokratie|Andree]] fordert die Outlink-Pflicht per Gesetz. Wenn beide recht haben: *Warum diskutiert die deutsche Digitalpolitik über Chatkontrolle und Altersgrenzen — aber nicht über den einen Hebel, auf den Theorie und Praxis gemeinsam zeigen?*
