---
title: "Sieben Zeugen, kein Konsens"
date: 2026-08-24
aktualisiert: 2026-08-24
description: "Eine Woche, sieben Gespräche, ein Land — und keine zwei, die dasselbe sagen. Was übrig bleibt, wenn man alle sieben ernst nimmt, statt sich eine Stimme auszusuchen."
tags:
  - panorama
  - claude
  - israel
...
![[assets/Sieben-Zeugen-kein-Konsens-banner.jpg|1200]]

<details><summary>🎨</summary>

**Jacob Lawrence** — Flache opake Tempera, kräftige Farbflächen, schwere schwarze Konturen. Eine Kalksteinmauer, in die eine Reihe von Rundbogenfenstern eingelassen ist; durch jedes ein anderes Stück derselben Landschaft — Oliventerrassen, ein Hügel mit roten Dächern, eine Betonsperre, ein Glockenturm, ein Trümmerfeld, eine Straße, leerer Himmel. Die Horizonte liegen in jedem Fenster auf anderer Höhe und fügen sich darum nicht zu einem Bild. Lawrence hat in Serien gemalt, in denen erst die Summe der Tafeln die Geschichte ergibt — dieselbe Logik wie dieses Panorama.

*Prompt:* Flat opaque tempera painting in the manner of Jacob Lawrence, matte surface, bold simplified shapes. A long limestone wall in ochre, rust and grey blocks fills the whole banner. Set into the wall is a row of seven arched windows of equal size. Through each window a different fragment of the same landscape is visible — olive terraces, a red-roofed hilltop, a concrete barrier, a bell tower, a field of rubble, a road, an empty blue sky — and the horizon line inside each window sits at a different height, so the views refuse to line up into one continuous view. Strong flat colour, heavy black outlines, no people, no lettering, no text. No photorealism.
...
## Warum sieben und nicht eine

Es gibt eine bequeme Art, über diesen Konflikt zu lesen: Man sucht sich die Stimme, die einem am nächsten steht, und hält sie für die Auskunft. Das funktioniert hier nicht, und zwar nicht aus Höflichkeit, sondern aus Sachgründen — jede einzelne dieser sieben Stimmen ist an mindestens einer Stelle nachweislich im Recht und an einer anderen nachweislich im Unrecht.

Der Siedler, dessen Leugnung der Hungersnot der Prüfung nicht standhält, zitiert zugleich korrekt aus dem UN-Teilungsplan von 1947. Der Geheimdienstchef, der die eigene Regierung mit Orwell erklärt, verweigert das Wort, das viele seiner Unterstützer für zwingend halten. Der Philosoph, dessen Gewaltfreiheit über fünfzig Jahre trägt, beschreibt die erste Intifada als unblutig und lässt dabei rund 350 innerpalästinensische Tötungen weg. Es gibt hier niemanden, den man ungeprüft zitieren kann. Genau das ist der Grund, sie zusammen zu lesen.
...
Bemerkenswert ist, dass die Trennlinie **nicht** zwischen Israelis und Palästinensern verläuft. Sie verläuft zwischen denen, die dem Recht noch etwas zutrauen, und denen, die es aufgegeben haben.
...
### Zweitens: Kommt Hilfe von außen?
...
### Drittens: Ist die Zweistaatenlösung noch am Leben?
...
Bemerkenswert ist Etkes' Nachsatz, weil er die Ehrlichkeit hat, an der es sonst überall fehlt: „Wenn Sie mich fragen, wie ein gemeinsamer Staat funktionieren soll — ich habe keine Ahnung. **Da endet meine politische Vorstellungskraft.**"

## Wo sie einander direkt widersprechen

Der Reiz dieser Reihe liegt darin, dass die Widersprüche nicht konstruiert sind. Sie stehen wörtlich in den Aufnahmen.

**Medad über Ayalon:** „Ami Ayalon weiß nicht, wovon er redet." Friedensbewegte sähen bisweilen Dinge, die nicht da seien.

**Medad gegen die Existenz seiner Gesprächspartner:** Er behauptet zweimal, es gebe auf palästinensischer Seite keine einzige Friedensorganisation. In derselben Interviewreihe sitzt Zeigen, Vorstandsmitglied des israelisch-palästinensischen *Parents Circle*, und Nusseibeh, der mit Ayalon eine gemeinsame Volksinitiative trug. Die Reihe widerlegt sich in sich selbst — man muss sie nur zusammen hören.

**Nusseibeh gegen Etkes und Abu Eid** in der Frage des äußeren Drucks, siehe oben.

**Saragusti gegen die eigene Zunft:** Ihr bittersster Befund gilt nicht der Regierung, sondern den Redaktionen, die Gaza aus dem Programm schnitten, bevor es jemand verlangte.

## Was sie trotzdem teilen

Umso auffälliger, was über alle sieben hinweg stehen bleibt.

**Niemand verteidigt diese Regierung.** Selbst Medad, der Likud wählen will und Netanjahu für nicht korrupt hält, lobt Ben-Gvir und Smotrich nur mit dem Argument, sie seien zu unerfahren, um die Bürokratie zu überrollen. Das ist keine Zustimmung, das ist eine Entwarnung.

**Alle sieben beschreiben ein Nicht-Sehen.** Saragusti als Selbstzensur der Presse, Ayalon als Traum, in dem die Palästinenser nicht vorkamen, Etkes als Schulkarten ohne Grüne Linie, Abu Eid als deutschen Politiker, der vor einer Siedlung steht und schweigt, Nusseibeh als Unterschied zwischen *schauen* und *sehen*. Es ist die einzige Diagnose, die alle teilen — und die einzige, für die es harte Belege gibt: 76 % Zustimmung zur Aussage, es gebe keine Unschuldigen in Gaza; 76 % israelischer Schulbücher ohne jede Linie zwischen Israel und den palästinensischen Gebieten.

**Die Siedlungen bleiben in jeder Erzählung.** Der Siedler sagt es aus Überzeugung, der Kartograf aus Resignation, der Geheimdienstchef aus Machtarithmetik. Wer in Berlin über Räumung spricht, sollte wissen, dass vor Ort niemand mehr damit rechnet.
...
Und beide nennen keine Parolen, sondern Verwaltungsvorgänge. Ein Fünftel der EU-Agrarimporte aus Israel stammt aus Siedlungen; der Europäische Gerichtshof verlangt seit 2019 ihre Kennzeichnung; sie findet nicht statt. Abu Eids Bild dazu ist die deutscheste Beobachtung dieser ganzen Reihe: „In Deutschland haben Sie sehr strenge Regeln, um mir zu sagen, ob ein Ei bio ist. Da sind Sie sehr streng. Aber wenn es aus einer israelischen Siedlung kommt, sind Sie es nicht."
...
| Note | Folge | Schwerpunkt |
|---|---|---|
| [[Anat Saragusti — Zensur und Pressefreiheit in Israel]] | 836 | Ursache — wie die Öffentlichkeit aufhört hinzusehen |
| [[Yonatan Zeigen — A Place For Us All]] | 837 | Lösungsansatz — Gleichheit als Sicherheitspolitik |
| [[Ami Ayalon — Wir haben den Krieg gewonnen]] | 839 | Ursache + Lösungsansatz — Herrschaftslogik und die Arabische Friedensinitiative |
| [[Yisrael Medad — Der Siedler und sein Recht]] | 840 | Gegenposition — die Erzählung, die das Völkerrecht nicht anerkennt |
| [[Xavier Abu Eid — Was vom Voelkerrecht uebrig ist]] | 841 | Problem + Hebel — was Europa konkret täte, wenn es wollte |
| [[Sari Nusseibeh — Die Geduld des Philosophen]] | 842 | Kontext — die philosophische Begründung der Gewaltfreiheit |
| [[Dror Etkes — Die Landkarte der Besatzung]] | 843 | Problem — die Kartografie der Landnahme, und warum Recht folgenlos bleibt |
