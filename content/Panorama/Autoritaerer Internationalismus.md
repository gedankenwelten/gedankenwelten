...
Das Neue am autoritären Internationalismus des 21. Jahrhunderts ist die **technologische Dimension**: Palantir übernimmt militärische Funktionen (\$10 Mrd. Pentagon-Vertrag), Musk kontrolliert über Starlink globale Kommunikationsinfrastruktur, DOGE zerlegt den US-Verwaltungsapparat von innen. Es ist nicht mehr Faschismus mit Braunhemden — es ist Faschismus mit Servern.

Dieses Panorama bündelt 30+ Notes, die das Phänomen aus fünf Perspektiven beleuchten: die Netzwerk-Infrastruktur, die Tech-Oligarchie, die ideologischen Werkzeuge, die Modell-Autokratien — und die Gegenstrategien.

---

## Das Problem

### Die Netzwerk-Infrastruktur: CPAC — Heritage — Atlas

[[Nachtsitzung — Die rechte Internationale: CPAC und sein Netzwerk bis nach Deutschland]] kartiert das Netzwerk in bisher nicht dokumentierter Tiefe:

**CPAC** (Conservative Political Action Conference) ist längst kein US-internes Event mehr. CPAC Hungary, finanziert mit ~3 Mio. € ungarischer Staatsgelder, fungiert als europäische Brücke. Die operative Dreifaltigkeit — *„No migration, no gender, no war"* — ist inzwischen US-Regierungspolitik. CPAC-Events fanden statt in Budapest, São Paulo, Sydney, Seoul und Mexiko-Stadt. ([Quelle: Wikipedia — CPAC](https://en.wikipedia.org/wiki/Conservative_Political_Action_Conference))

**Heritage Foundation / Project 2025** ist der intellektuelle Motor: 920 Seiten Blaupause, verfasst von Hunderten Konservativen, fast die Hälfte der beteiligten Organisationen finanziert durch Dark Money aus Leonard Leos Netzwerk. Laut *Time*-Analyse ähnelten vier Tage nach Amtsantritt knapp ⅔ von Trumps Executive Actions Vorschlägen aus P2025 — wobei „mirror or partially mirror" nicht gleichbedeutend mit vollständiger Umsetzung ist. Russell Vought (Project-2025-Schlüsselfigur) identifizierte „Christian Nationalism" als Top-Priorität für Trumps zweite Amtszeit. Sechs von Trumps Kabinettsmitgliedern sind Autoren des *Mandate for Leadership*. JD Vance schrieb das Vorwort zu Kevin Roberts' Buch. ([Quelle: Wikipedia — Project 2025](https://en.wikipedia.org/wiki/Project_2025))

**Atlas Network** ist der globale Multiplikator: Gegründet 1981 von Antony Fisher (Hayek-Schüler), heute fast 600 Partnerorganisationen in über 100 Ländern. Selbstbeschreibung: „A think tank that creates think tanks." Das Netzwerk ist nachweislich verbunden mit der Tabakindustrie (ein Fünftel der Partner hat Tabakkontrollen bekämpft oder Tabakspenden angenommen), Öl- und Gaslobby, Anti-Klimaschutz-Kampagnen. In Deutschland operieren Atlas-Partner über FDP-nahe Strukturen (Prometheus-Institut, Frank Schäffler). ([Quelle: Wikipedia — Atlas Network](https://en.wikipedia.org/wiki/Atlas_Network))

**Steve Bannon** erklärte sich zum AfD-Berater (dokumentiert in Epstein-Akten). Das **US State Department** finanziert rechte NGOs in London, Paris, Berlin und Brüssel. Die neue **R21/Denkfabrik** (Inauguralsitzung April 2026) bringt diese Ideologie in die CDU/CSU.

→ [Lösungsansatz ↓](#transparenz-und-netzwerk-kartierung)

---

### Die Tech-Oligarchie: Privatisierte Souveränität

[[Francesca Bria — The Authoritarian Stack]] liefert die Metaanalyse mit einer interaktiven Forschungsdatenbank: 250+ Akteure, \$45 Mrd. Geldflüsse, verifizierte Verbindungen. Brias Kernthese: Was wir erleben, ist nicht Lobbyismus — es ist **privatisierte Souveränität** über fünf Governance-Domänen. Der Palantir-Pentagon-Vertrag (\$10 Mrd., Juli 2025) steht für die strategische Übergabe militärischer Funktionen an ein privates Technologieunternehmen, gegründet von Peter Thiel — demselben Thiel, der JD Vances Kampagne mit \$15 Mio. finanzierte.

[[Rainer Mühlhoff — Künstliche Intelligenz und der neue Faschismus]] analysiert den Mechanismus: KI-Hype als systematische Diskursdivergenz (Industrie/Investor-Feedbackschleifen), Datenextraktion als **Kolonialismus des 21. Jahrhunderts**, Tech-Übernahme staatlicher Funktionen (DOGE/Palantir-Modell), Desouveränisierung demokratischer Entscheidungsprozesse. Longterminism ist umbenannte Eugenik: IQ-Hierarchien, die unter dem Deckmantel von „Effektiver Altruismus" die Demokratie als ineffizient verwerfen.
...
### Die ideologischen Werkzeuge: Great Replacement, Phantom-Besitz, Agnotologie

[[Ibram X. Kendi — Great Replacement Theory und der Weg zur Wahlautokratie]] dekonstruiert das wichtigste ideologische Werkzeug des autoritären Internationalismus. Die GRT ist **kein Randphänomen**: Tucker Carlson sendete 400 Referenzen in 50 Stunden Primetime. International tragen Trump, Orbán, Meloni, Farage und Bukele dieselbe Erzählung — lokal adaptiert, aber strukturell identisch. Der Mechanismus: Wenn die Bevölkerung glaubt, „ausgetauscht" zu werden, stimmt sie autoritärer Herrschaft als „Schutz" zu. Das ist der Weg zur **Wahlautokratie** — Demokratie mit Wahlen, aber ohne demokratische Substanz.

Entscheidend ist Kendis **Racial Coding**: Die GRT fürchtet nicht den Austausch durch weiße Einwanderer, sondern spezifisch durch *People of Color*. Die historische Parallele zum NS-Antisemitismus ist direkt — andere Zielgruppe, identischer Mechanismus.

[[Eva von Redecker — Über den neuen Faschismus (Jung & Naiv 811)]] liefert den philosophischen Rahmen: Faschismus als **„liquidierende Phantombesitzverteidigung"** — wenn Machthaber etwas nicht besitzen können, zerstören sie es. Trumps Grönland-Forderung, Muks Weltraum-Claims, Bukeles Gefängnis-Staat: *„You know, because you can."* Curtis Yarvins Einfluss: Staat als Eigentum — wer die Zerstörung kontrolliert, besitzt. Arendts Unterscheidung Macht (kollektives Handeln) vs. Gewalt (Zwang) zeigt: Trump verliert Legitimität → steigert Zerstörungskapazität.

[[ARTE — Forschung Fake und faule Tricks]] dokumentiert das dritte Werkzeug: **Agnotologie** — die industrielle Produktion von Unwissen. Die Genealogie: Tabak → Klima → Migration → Demokratie. Das Atlas Network hat nachweislich ein Fünftel seiner Partner mit Tabak-Desinformation verknüpft. Dieselben Methoden, dieselben Akteure, derselbe Zweck: Zweifel produzieren, um Regulierung zu verzögern und demokratische Handlungsfähigkeit zu untergraben.

[[Rainer Mausfeld — Warum schweigen die Lämmer]] ergänzt die psychologische Dimension: Angstproduktion als ältestes Machtwerkzeug. Drei Techniken: Illusion der Informiertheit, Angsterzeugung, Ohnmachtsgefühl. Bernays zitierend: Propaganda = Produktion freiwilliger Zustimmung. Platons Höhle ist heute Algorithmus, Blase, Smartphone.

→ [Lösungsansatz ↓](#gegennarrative-und-faschismus-literalität)

---

### Die Modell-Autokratien: Orbán, Trump, Erdoğan

[[Ece Temelkuran — So beginnt Faschismus in Amerika]] destilliert aus dem Vergleich Türkei/USA ein **Sieben-Stufen-Modell** der demokratischen Erosion:

1. **Moment schaffen** — Erzählung, dass eine Ära endet
2. **Opfernarrative** — die Mehrheit als Bedrohte
3. **Wahrheitsverzerrung** — Fakten werden verhandelbar
4. **Scham abbauen** — was gestern undenkbar war, ist morgen sagbar
5. **Über Horror lachen** — Normalisierung durch Humor
6. **Justiz kapern** — Gewaltenteilung aushöhlen
7. **Diktatur bauen** — formale Demokratie, faktische Autokratie

Temelkurans entscheidende Beobachtung: Die **Geschwindigkeit** und **Waffenisierung** unter Trump sind einzigartig — Erdoğan brauchte Jahrzehnte, Trump erledigt es in einer Amtszeit. Aber: Immigrant*innen und Exilierte sind eine einzigartige Widerstandsressource — sie wissen, wie man Heimat wieder aufbaut.
...
- **Deutschland** (Springer/Döpfner): orchestrierte politische Einflussnahme; ÖR unter Druck

→ [Lösungsansatz ↓](#unabhängige-medien-schützen)

---

### Die Propagandamaschine: Desinformation als System

[[Topfvollgold — BILD und NIUS: Wie erfundene Geschichten Hass schüren]] dokumentiert den Mechanismus als Fallstudie: Eine erfundene „Afghanen-Shopping-Geschichte" (BILD, September 2025) verbreitet sich zu AfD, Influencern, Compact (mit KI-Fakes). Die wahre Geschichte: Flugverspätung + Rollstuhl-Problem, kein Shopping. Die 47 Afghanen waren **Demokratie-Aktivisten**, deren Aufnahme Trump suspendierte. BILD ließ die Lüge 8 Tage online. Das zeigt die **Integration** von Mainstream (BILD) und Alt-Right (Compact/NIUS) Medien-Ökosystemen — kein Zufall, sondern Architektur.
...
**Phantom-Besitz:** [[Eva von Redecker — Dieser Drang nach Härte]] historisiert: Neofaschismus ist individualistischer als historischer Faschismus (Anspruchshaltung statt Massenformation). Medien fragmentieren (KI/Plattformen) statt zu homogenisieren (Radio), koordinieren aber trotzdem Gewalt. Ausnahmezustandslogik: Demagogie erzeugt Fiktion des Notstands → Gewalt erscheint als Selbstverteidigung. Das AWEF in Prag, Trumps Executive Orders, Bukeles Massenverhaftungen — verschiedene Formen derselben Logik.

---

## Lösungsansätze

### Transparenz und Netzwerk-Kartierung

✅ **Trägt bei** — [[Francesca Bria — The Authoritarian Stack]] zeigt den Weg: Interaktive Forschungsdatenbanken, die Geldflüsse, Personalverbindungen und Organisationsstrukturen kartieren und öffentlich zugänglich machen. Finanziert von Rosa-Luxemburg-Stiftung und Friedrich-Ebert-Stiftung. Das Problem ist Asymmetrie: Autoritäre Netzwerke haben Milliardäre, demokratische Kartierungsprojekte haben Spendenaufrufe. Aber Sichtbarkeit ist der erste Schritt zur Regulierung. Atlas Networks 600 Partner in 100 Ländern müssen genauso transparent kartiert werden wie Heritage, CPAC und ihre Dark-Money-Ströme.
...
Und [[Geistesblitz/Fediverse - Die digitale Allmende|Fediverse — Die digitale Allmende]] zeigt, dass die Infrastruktur für diese Souveränität bereits existiert: ActivityPub als offenes Protokoll, keine zentrale Autorität, keine Kill-Switch-Macht eines einzelnen Akteurs. Wähner und Stockmann beschreiben soziologisch und strategisch, warum dieser Gegenentwurf trotzdem nicht von selbst wächst — und was es bräuchte (zivilgesellschaftliche Trägerschaft, öffentliche Grundfinanzierung, Design-Investitionen), damit er zur tatsächlichen Alternative wird.

Verbundene Notes: [[Rainer Mühlhoff — Künstliche Intelligenz und der neue Faschismus]] · [[Anna-Verena Nosthoff — Kybernetik und die Macht der Tech-Eliten (scobel)]] · [[Adam Tooze — Pentagon vs. Anthropic]] · [[Zeitgeist/Martin Andree - Monopole zerstoeren unsere Demokratie|Martin Andree — Monopole zerstören unsere Demokratie]] · [[Geistesblitz/Fediverse - Die digitale Allmende|Fediverse — Die digitale Allmende]]

---

### Gegennarrative und Faschismus-Literalität

✅ **Trägt bei** — [[Dietrich Bonhoeffer — Theorie der Dummheit]] zeigt: Faktenchecks allein wirken nicht, weil „Dummheit" keine intellektuelle Schwäche ist, sondern eine aktive Entscheidung unter sozialem Druck. Es braucht Gegennarrative, die **emotional** funktionieren — nicht nur rational. [[Erich Fromm — Psychoanalyse des Faschismus]] ergänzt: Der autoritäre Charakter braucht Unterwerfung, weil Freiheit Angst macht. Die Gegenstrategie ist nicht Belehrung, sondern: **Freiheit attraktiver machen als Unterwerfung.** Kempers Faschismus-Typologie, Redeckers Phantombesitz-Analyse und Temelkurans Sieben-Stufen-Modell gehören in die politische Bildung — als Werkzeuge zur Selbstdiagnose.

Verbundene Notes: [[Dietrich Bonhoeffer — Theorie der Dummheit]] · [[Erich Fromm — Psychoanalyse des Faschismus]] · [[Eva von Redecker — Dieser Drang nach Härte]] · [[Ece Temelkuran — So beginnt Faschismus in Amerika]]
...
### Demokratische Kultur statt nur Institutionen

✅ **Trägt bei** — [[Gesine Schwan — Macht NEU DENKEN]] unterscheidet Herrschaftsmacht (Dominanz) von Gestaltungsmacht (kooperative Macht). Demokratie braucht nicht nur Institutionen, sondern **demokratische Kultur** — das Einüben kooperativen Handelns. Schwans kommunale Entwicklungsbeiräte, Bürgerräte, partizipative Budgets sind Proof-of-Concepts. [[Hannah Arendt — Denken ohne Geländer]] ergänzt: Wenn Traditionen versagen, sind Skeptiker verlässlicher als Gläubige. Die totalitäre Versuchung besteht nicht in Ideologie, sondern in der Verwandlung der menschlichen Natur — Gegenmittel ist das **Denken ohne Geländer**: eigenständiges Urteilen ohne fertige Antworten.

Verbundene Notes: [[Gesine Schwan — Macht NEU DENKEN]] · [[Hannah Arendt — Denken ohne Geländer]] · [[Hannah Arendt — Die Banalität des Bösen]]

---

### Subversive Freundlichkeit und Exil-Resilienz
...
### Innere Resilienz — Was Systeme nicht konditionieren können

⚠️ **Tiefste Schicht, aber keine politische Lösung** — Wenn Fromms autoritärer Charakter eine *Flucht vor der Freiheit* ist und Gefangene des Systems zeigt, dass Eliteerziehung Empathie systematisch zerstört — dann stellt sich die Frage: Was erzeugt **echte Resilienz** gegen diese Konditionierung? Nicht politische Programme, sondern die Fähigkeit, den eigenen konditionierten Reaktionen nicht blind zu folgen.

[[S.N. Goenka — Vipassana]] liefert den präzisesten Mechanismus: **Sankhāra** (konditionierte Reaktionsmuster) sind exakt das, was autoritäre Systeme installieren — Angst → blinder Gehorsam, Gier → Unterwerfung unter Macht. **Vedanā** (Körperempfindungen) ist der Punkt, an dem die Kette bricht: Zwischen Reiz und Reaktion liegt ein Moment der Wahrnehmung, der trainierbar ist. **Upekkhā** (Gleichmut) ist nicht Passivität, sondern die Fähigkeit, mit voller Kraft zu handeln, ohne von Angst oder Hass getrieben zu werden. Goenka selbst warnt vor spiritueller Passivität: *Handle mit voller Kraft — aber aus Gleichmut, nicht aus Reaktivität.*

[[Matthieu Ricard — Altruismus als Vernunft]] ergänzt die entscheidende Einschränkung: Achtsamkeit ohne ethische Ausrichtung ist wertlos — *„ein achtsamer Söldner tötet alle"*. Mindfulness allein stoppt keine Heritage Foundation. Aber Ricard zeigt auch: Mitgefühl ist **trainierbar** — neurowissenschaftlich nachweisbar (Davidson-Studie). Das ist relevant, weil Schaverians ABCD-Modell zeigt, dass Empathie-Fähigkeit durch Erziehung *zerstört* werden kann — Ricard zeigt, dass sie *wiederherstellbar* ist.

**Worin liegt die Relevanz für den autoritären Internationalismus?** Nicht darin, dass Meditation Faschismus stoppt — das wäre naiv. Sondern darin, dass *ohne* innere Resilienz alle strukturellen Lösungen (Regulierung, Bildung, Journalismus) auf dem gleichen psychologischen Substrat aufbauen, das sie bekämpfen: konditionierte Angstreaktionen. Viktor Frankls Lücke zwischen Reiz und Reaktion — *„In dieser Lücke liegt unsere Freiheit"* — ist die philosophische Brücke zwischen Fromms Diagnose und einer Antwort, die tiefer greift als Institutionen.

Verbundene Notes: [[S.N. Goenka — Vipassana]] · [[Matthieu Ricard — Altruismus als Vernunft]] · [[Gefangene des Systems — Elitenerziehung und die Verrohung der Macht]]

---

## Offene Fragen

- Wie reagieren Demokratien, wenn ein einzelner Mensch (Musk) über Starlink die Kommunikationsinfrastruktur ganzer Länder kontrolliert?
- Kann die EU mit DSA und AI Act eine Alternative zum US-Modell (Tech-Oligarchie) und China-Modell (Staats-Überwachung) etablieren?
...
| Quelle | Beschreibung |
|---|---|
| [Wikipedia — Project 2025](https://en.wikipedia.org/wiki/Project_2025) | 920-Seiten-Blaupause der Heritage Foundation; laut *Time*-Analyse ähnelten ⅔ von Trumps ersten Executive Actions P2025-Vorschlägen; Dark-Money-Finanzierung durch Leonard Leos Netzwerk |
| [Wikipedia — Atlas Network](https://en.wikipedia.org/wiki/Atlas_Network) | ~600 Partner in 100+ Ländern; gegründet 1981 (Hayek/Fisher); nachweisliche Tabak- und Öl-Lobbyverflechtung |
| [Wikipedia — CPAC](https://en.wikipedia.org/wiki/Conservative_Political_Action_Conference) | Globale Expansion: Budapest, São Paulo, Seoul, Sydney; CPAC Hungary mit ~3 Mio. € Staatsfinanzierung |
| [The Authoritarian Stack](https://www.the-authoritarian-stack.com/) | Francesca Brias interaktive Datenbank: 250+ Akteure, \$45 Mrd. Geldflüsse, finanziert von RLS + FES |
| [CORRECTIV — Geheimplan gegen Deutschland](https://correctiv.org/aktuelles/neue-rechte/2024/01/10/geheimplan-remigration/) | Sellners Remigrations-Masterplan vor AfD-Funktionären — die internationale Dimension (Sellner = Identitäre Bewegung Österreich) |
...
| [[Koschi Politik — Gute Nachrichten: Bondi raus, Supreme Court & Meinungswandel Immigration]] | Empirie · US-Gegenbewegung |
