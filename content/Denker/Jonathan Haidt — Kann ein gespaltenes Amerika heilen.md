...
tags:
  ...
  - usa
aliases:
  - Haidt Divided America
  - Haidt TED Polarisierung
---
...
[▶ 0:45](https://www.ted.com/talks/jonathan_haidt_can_a_divided_america_heal?t=45)
...
### 2. Die neue Links-Rechts-Spaltung

[▶ 2:17](https://www.ted.com/talks/jonathan_haidt_can_a_divided_america_heal?t=137)

Das alte Links-Rechts-Schema (Arbeit vs. Kapital, Marx) wird abgelöst durch eine neue Spaltung:

| Lokal / National | Global / Kosmopolitisch |
|---|---|
| Verwurzelt, Heimat, Gemeinschaft | "Imagine" (John Lennon) — keine Grenzen |
| Brexit-Wähler, Trump-Wähler | EU-Befürworter, offene Grenzen |
| Zugbrücke hochziehen | Zugbrücke runterlassen |
...
[▶ 4:36](https://www.ted.com/talks/jonathan_haidt_can_a_divided_america_heal?t=276)
...
[▶ 6:51](https://www.ted.com/talks/jonathan_haidt_can_a_divided_america_heal?t=411)
...
[▶ 7:36](https://www.ted.com/talks/jonathan_haidt_can_a_divided_america_heal?t=456)
...
[▶ 11:32](https://www.ted.com/talks/jonathan_haidt_can_a_divided_america_heal?t=692)
...
[▶ 14:42](https://www.ted.com/talks/jonathan_haidt_can_a_divided_america_heal?t=882)
...
[▶ 15:31](https://www.ted.com/talks/jonathan_haidt_can_a_divided_america_heal?t=931)

> *„Wir sind alle in der Matrix gefangen. Jede Moralgemeinschaft ist eine Matrix — eine einvernehmliche Täuschung."*

In der blauen Matrix: Die andere Seite sind Primitive, Rassisten, die schlimmsten Menschen der Welt — und man hat genug Fakten dafür.
In der roten Matrix: Dieselbe Gewissheit, andere Fakten, andere Bedrohungen.
...
[▶ 13:05](https://www.ted.com/talks/jonathan_haidt_can_a_divided_america_heal?t=785)
...
[▶ 17:49](https://www.ted.com/talks/jonathan_haidt_can_a_divided_america_heal?t=1069)
...
> [!success] Bestätigt
> Gottmans *Cascade Model of Relational Dissolution* (1992–1994) identifiziert vier Destruktionsmuster: Kritik → Defensivität → **Verachtung** → Mauern. Die Forschung (mit Robert Levenson) belegt: *"not all negative interactions, like anger, are predictive of relational separation and divorce"* — aber Verachtung (contempt) ist *"the strongest predictor of relational dissolution."* Haidts Formulierung — Verachtung stärkster Prädiktor, Wut sagt nichts vorher — entspricht exakt Gottmans publizierten Befunden.
> **Einschränkung:** Gottmans berühmte "91% Vorhersagegenauigkeit" wurde von Heyman (2001) und anderen kritisiert — Overfitting, kleine Stichproben, keine unabhängige Validierung. Die *relative* Bedeutung von Verachtung vs. Wut ist aber robust repliziert.
>
> 📎 Gottman, J. M. & Levenson, R. W. (1992). *Marital processes predictive of later dissolution.* Journal of Personality and Social Psychology, 63(2), 221–233.
> 📎 Heyman, R. E. (2001). *Observation of couple conflicts.* Clinical Child and Family Psychology Review, 4(3), 185–205.
...
>
> 📎 Pew Research Center (Juni 2016). *Partisanship and Political Animosity in 2016.* [pewresearch.org](https://www.pewresearch.org/politics/2016/06/22/partisanship-and-political-animosity-in-2016/)

---

## Weiterführende Quellen (Sherlock)

| Claim | Primärquelle | Zugang |
|---|---|---|
| Putnam Diversität | Putnam, R.D. (2007). *E Pluribus Unum.* Scandinavian Political Studies 30(2) | [JSTOR](https://doi.org/10.1111/j.1467-9477.2007.00176.x) |
| Stenner Autoritarismus | Stenner, K. (2005). *The Authoritarian Dynamic.* Cambridge UP | Buch / [Wikipedia](https://en.wikipedia.org/wiki/Karen_Stenner) |
| Gottman Verachtung | Gottman & Levenson (1992). *Marital processes predictive of later dissolution.* JPSP 63(2) | [APA PsycNet](https://doi.org/10.1037/0022-3514.63.2.221) |
| Gottman-Kritik | Heyman, R.E. (2001). *Observation of couple conflicts.* CCFPR 4(3) | [Springer](https://doi.org/10.1023/A:1017900707208) |
| Krieg & Kooperation | Bauer et al. (2016). *Can War Foster Cooperation?* JEP 30(3) | [AEA (Open Access)](https://www.aeaweb.org/articles?id=10.1257/jep.30.3.249) |
| Negative Partisanship | Abramowitz & Webster (2016). *Rise of negative partisanship.* Electoral Studies 41 | [ScienceDirect](https://doi.org/10.1016/j.electstud.2015.11.001) |
| Pew Polarisierung | Pew Research (2016). *Partisanship and Political Animosity in 2016* | [pewresearch.org](https://www.pewresearch.org/politics/2016/06/22/partisanship-and-political-animosity-in-2016/) |

---

## Einordnung

> [!abstract] Was diese Perspektive bietet
...
### → [[Gedanken/Stammeslogik und Cancel Culture]]
