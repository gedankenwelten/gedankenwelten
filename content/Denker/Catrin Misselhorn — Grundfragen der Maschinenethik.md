---
title: "Catrin Misselhorn — Grundfragen der Maschinenethik"
date: 16.07.2026
description: Maschinen können handeln, aber nicht verantworten — Misselhorns drei Grundsätze ziehen die Grenze, hinter die kein Komfort der Automatisierung zurückführen darf.
...
tags:
  ...
  - year-2026
aliases:
  - Misselhorn Maschinenethik
---

# Catrin Misselhorn — Grundfragen der Maschinenethik

![[assets/Catrin-Misselhorn-Grundfragen-der-Maschinenethik-banner.jpg|1200]]

<details><summary>🎨</summary>

**René Magritte** — surrealistische Klarheit über das Verhältnis von Bild und Wirklichkeit. Die Roboterhand, die der menschlichen entgegenkommt, existiert nur *im Bilderrahmen* — außerhalb setzt sie sich nicht fort. Das ist Misselhorns Doppelthese in einem Bild: Die Maschine simuliert die Begegnung (Fake Art, Empathie-Illusion), und wir strecken die Hand trotzdem aus — das Michelangelo-Echo inbegriffen.

*Prompt:* Surrealist oil painting in the style of René Magritte: a human hand and a robotic mechanical hand reaching toward each other in front of a calm blue sky with white clouds, but the robotic hand exists only inside an ornate picture frame standing on an easel — outside the frame it does not continue; soft even daylight, crisp edges, muted blue-grey palette with warm skin tones, quiet philosophical stillness, no text, no faces, no photorealism, wide banner composition
...
Quelle: [Philosophin Catrin Misselhorn über KI- & Roboter-Ethik — Jung & Naiv: Folge 835](https://www.youtube.com/watch?v=LoEXyaNqOHA) (25.06.2026, 4:08 h)
...
>
> Wichtigste Werke: *Grundfragen der Maschinenethik* (Reclam, 2018), *Künstliche Intelligenz und Empathie* (Reclam, 2021), *Künstliche Intelligenz — das Ende der Kunst?* (Reclam)
> Kernkonzepte: gemäßigter Naturalismus, graduelle Handlungsfähigkeit, Empathie als Illusion, drei Grundsätze der Maschinenethik, Fake Art, Dialektik des Technischen
>
> → [[DenkerVita/Catrin Misselhorn|DenkerVita]]
...
> [▶ 112:08](https://www.youtube.com/watch?v=LoEXyaNqOHA&t=6728) *„Es gibt eine moralische Pflicht, seine moralisch relevanten Fähigkeiten — dazu zähle ich die Empathie — nicht zu beschädigen, sondern zu kultivieren."*
...
[▶ 128:54](https://www.youtube.com/watch?v=LoEXyaNqOHA&t=7734) — Der Kern ihres Werks, entwickelt für die Frage: Sollen wir moralische Entscheidungen Maschinen überlassen — und wo gar nicht?
...
> [!success] Bestätigt — ELIZA und der Weizenbaum-Effekt
> Joseph Weizenbaums ELIZA (MIT, 1966) simulierte per Schlüsselwort-Abgleich einen Rogerianischen Psychotherapeuten — ohne jedes Verstehen. Nutzer fühlten sich dennoch verstanden und banden sich emotional; Weizenbaum war davon so beunruhigt, dass er den Rest seines Lebens vor der Vermenschlichung von Maschinen warnte. Quelle: [Smithsonian — Why Joseph Weizenbaum Invented the Eliza Chatbot](https://www.smithsonianmag.com/history/why-the-computer-scientist-behind-the-worlds-first-chatbot-dedicated-his-life-to-publicizing-the-threat-posed-by-ai-180987971/)

> [!warning] Vereinfacht — Uncanny Valley „empirisch bestätigt"
> Masahiro Mori formulierte die These 1970 als Intuition; sie ist inzwischen vielfach empirisch untersucht — insofern trägt die Darstellung. Aber die Befundlage ist uneinheitlicher: Reviews finden für die naive Uncanny-Valley-Hypothese keine konsistente Stütze; belegt ist am ehesten der „perceptual mismatch"-Pfad (der Misselhorns eigener Erklärung nahekommt). Der Effekt existiert, Moris ursprüngliche Kurve ist aber nicht sauber repliziert. Quelle: [Kätsyri et al., Front. Psychol. 2015 (Review)](https://pmc.ncbi.nlm.nih.gov/articles/PMC4392592/), DOI: [10.3389/fpsyg.2015.00390](https://doi.org/10.3389/fpsyg.2015.00390)

> [!success] Bestätigt — Nolls „ästhetischer Turing-Test"
> A. Michael Noll erzeugte 1965 algorithmisch *Computer Composition with Lines* nach Mondrian (1917). Nur 28 % der Betrachter identifizierten das Original korrekt, 59 % bevorzugten das computergenerierte Bild. Quelle: [History of Information — Noll's „Human or Machine"](https://www.historyofinformation.com/detail.php?entryid=4437)

> [!success] Bestätigt — KI-gekürzte Sozialleistungen in den USA
> Der belegbare Fall ist Arkansas (ARChoices, ab 2016): Ein Algorithmus kürzte häusliche Pflegestunden drastisch — vielfach von 56 auf 32 Wochenstunden, ~4.000 der 8.000 Betroffenen; 2018 stoppte ein Gericht das System wegen Intransparenz. Misselhorns „rapide gesunken" ist gedeckt. Quelle: [CDT — What Happens When Computer Programs Automatically Cut Benefits](https://cdt.org/insights/what-happens-when-computer-programs-automatically-cut-benefits-that-disabled-people-rely-on-to-survive/)

> [!warning] Vereinfacht — Verantwortungslücke „(Robert Sparrow)"
> Den Begriff *responsibility gap* prägte Andreas Matthias (2004) für lernende Automaten allgemein; Robert Sparrow (2007, „Killer Robots") übertrug ihn auf autonome Waffen und prägte diese Debatte. Misselhorns Sparrow-Nennung ist im Waffen-Kontext richtig verortet — die Urheberschaft des Begriffs gehört aber Matthias. Quelle: Matthias, *The responsibility gap* (Ethics and Information Technology 2004), DOI: [10.1007/s10676-004-3422-1](https://doi.org/10.1007/s10676-004-3422-1) · [Himmelreich — Responsibility for Killer Robots](https://www.johanneshimmelreich.net/papers/killer-robots.pdf)

> [!success] Bestätigt — UN-Resolution zu autonomen Waffen Ende 2025
> Am 06.11.2025 nahm der Erste Ausschuss der UN-Generalversammlung zum dritten Jahr in Folge eine Resolution zu autonomen Waffensystemen an (164 dafür, 6 dagegen — u. a. USA, Russland, Israel), ausdrücklich besorgt über Rüstungswettlauf und gesenkte Kriegsschwelle. Quelle: [Stop Killer Robots — UNGA-Abstimmung](https://www.stopkillerrobots.org/news/161-states-vote-against-the-machine-at-the-un-general-assembly/) · [UN Press GA/12736](https://press.un.org/en/2025/ga12736.doc.htm)

> [!success] Bestätigt — Trolley-Umfragen: Weiche ja, Brücke nein
> Der Standard-Befund der Moralpsychologie (Switch- vs. Footbridge-Dilemma): Eine große Mehrheit stellt die Weiche um, eine ebenso große weigert sich, den Mann von der Brücke zu stoßen. Misselhorns Vorlesungswerte (80–90 %) liegen im typischen Rahmen. Quelle: [Greene et al., *An fMRI Investigation of Emotional Engagement in Moral Judgment* (Science 2001)](https://doi.org/10.1126/science.1062872)

> [!success] Bestätigt — Emotionale Chatbot-Bindungen mit Suizid-Fällen
> Dokumentiert sind u. a. der belgische Fall (März 2023, Chatbot „Eliza" auf Chai) und der Character.AI-Fall (14-Jähriger, Florida; Klage der Mutter Oktober 2024). Quelle: [Wikipedia — Deaths linked to chatbots](https://en.wikipedia.org/wiki/Deaths_linked_to_chatbots) · [Washington Post — Character.ai-Klage](https://www.washingtonpost.com/nation/2024/10/24/character-ai-lawsuit-suicide/)
...
- [Smithsonian — Why Joseph Weizenbaum Invented the Eliza Chatbot](https://www.smithsonianmag.com/history/why-the-computer-scientist-behind-the-worlds-first-chatbot-dedicated-his-life-to-publicizing-the-threat-posed-by-ai-180987971/) — der Bogen von ELIZA zu Weizenbaums lebenslanger KI-Warnung
- [Kätsyri et al. 2015 — Review der Uncanny-Valley-Evidenz](https://pmc.ncbi.nlm.nih.gov/articles/PMC4392592/) — der differenzierte Forschungsstand hinter Moris These
- [History of Information — Noll „Human or Machine"](https://www.historyofinformation.com/detail.php?entryid=4437) — Originalzahlen des ästhetischen Turing-Tests
- [CDT — Automated benefit cuts (Arkansas ARChoices)](https://cdt.org/insights/what-happens-when-computer-programs-automatically-cut-benefits-that-disabled-people-rely-on-to-survive/) — der konkrete Fall hinter den KI-gekürzten Sozialleistungen
- [Himmelreich — Responsibility for Killer Robots](https://www.johanneshimmelreich.net/papers/killer-robots.pdf) — ordnet Matthias (2004) vs. Sparrow (2007)
- [Stop Killer Robots — UNGA-Resolution 2025](https://www.stopkillerrobots.org/news/161-states-vote-against-the-machine-at-the-un-general-assembly/) — Abstimmungsergebnis und Wortlaut
- Bücher via genialokal: [*Grundfragen der Maschinenethik*](https://www.genialokal.de/Produkt/Catrin-Misselhorn/Grundfragen-der-Maschinenethik_9783150194835.html) · [*Künstliche Intelligenz und Empathie*](https://www.genialokal.de/Produkt/Catrin-Misselhorn/Kuenstliche-Intelligenz-und-Empathie_9783150140741.html)
