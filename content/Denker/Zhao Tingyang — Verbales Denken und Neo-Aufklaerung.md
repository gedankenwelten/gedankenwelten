---
title: "Zhao Tingyang — Verbales Denken und Neo-Aufklärung"
...
tags:
  ...
  - year-2025
aliases:
  - Zhao Verbales Denken
  - Verb-Denken Neo-Aufklärung
---
...
[▶ 1:36](https://www.youtube.com/watch?v=8_gea_85sK0&t=96) Zhao beginnt mit einem autobiographischen Hinweis: Er beschäftigt sich mit dem verbalen Denken seit seinem Buch *One or All Problem* (1998). Dann trifft er auf Komplexitätswissenschaft — und merkt, dass beide Projekte dasselbe Problem haben, ohne bislang eine methodologische Antwort gefunden zu haben.
...
[▶ 59:22](https://www.youtube.com/watch?v=8_gea_85sK0&t=3562) Zhao gibt eine evolutionstheoretisch informierte Erklärung. Gesprochene Sprache entstand im Paläolithikum — vor 50.000 bis 130.000 Jahren. Die Informationen, die damals überlebenswichtig waren, waren **Klassifikationsmerkmale**: Ist das ein Löwe oder eine Antilope? Ist diese Pflanze giftig oder essbar? Freund oder Feind?
...
[▶ 50:47](https://www.youtube.com/watch?v=8_gea_85sK0&t=3047) Mathematik ist in Zhaos Deutung das erfolgreichste Verb-Denksystem der Menschheit. Funktionen, Differenzialgleichungen, Operatoren — das sind ausgereifte Verben: Sie beschreiben nicht *was* etwas ist, sondern *wie* es sich verhält, *was es tut*, *wie es sich verändert*.
...
[▶ 52:24](https://www.youtube.com/watch?v=8_gea_85sK0&t=3144) Das zeigt sich besonders bei Emergenz: Wenn etwas wirklich Neues entsteht — eine neue Lebensform, eine neue soziale Praxis, ein neues Bewusstsein — dann versagt die Mathematik. Sie kann beschreiben, *dass* etwas entstand, aber nicht das qualitative *Was* des Entstehens.
...
[▶ 70:55](https://www.youtube.com/watch?v=8_gea_85sK0&t=4255) Hier wird Zhao am technisch präzisesten. Das Problem: Die formale Logik kennt nur einen Verb-Ausdruck: **Implikation** (*wenn P, dann Q*). Implikation überträgt Wahrheit — wenn die Prämisse wahr ist, ist die Schlussfolgerung wahr. Das ist sauber, elegant, und für analytische Aussagen vollständig.
...
> [!success] Bestätigt — Santa-Fe-Institut 1984
> Das Santa Fe Institute wurde 1984 gegründet, mit Nobelpreisträgern (insbesondere Murray Gell-Mann als Mitgründer) und explizit als Zentrum für Komplexitätswissenschaft. Quelle: [Santa Fe Institute — Wikipedia](https://en.wikipedia.org/wiki/Santa_Fe_Institute)

> [!success] Bestätigt — Geoffrey Hinton, Nobelpreis 2024
> Geoffrey Hinton erhielt 2024 den Physik-Nobelpreis (gemeinsam mit John Hopfield) für grundlegende Entdeckungen zum maschinellen Lernen. Quelle: [Nobel Prize 2024 Physics](https://www.nobelprize.org/prizes/physics/2024/summary/)

> [!danger] Falsch — Hinton als Urheber des Paläolithikum-Zitats
> Das Zitat „Humans have paleolithic emotions, medieval institutions, and god-like technology" stammt nicht von Geoffrey Hinton, sondern vom Biologen und Soziobiologen **Edward O. Wilson**, der es in mehreren Büchern und Vorträgen verwendet hat. Die Attribuierung an Hinton ist eine verbreitete Fehlzuschreibung — vermutlich weil Wilsons Diagnose inhaltlich zu Hintons KI-Warnungen passt. Zhao zitiert im Vortrag „Hinton" — die Fehler liegt beim Sprecher. Quelle: [E.O. Wilson — Wikiquote](https://en.wikiquote.org/wiki/E._O._Wilson)

> [!warning] Vereinfacht — Leibniz, *principium rationis sufficientis*, in der Logik „abgelehnt"
...
> [!warning] Vereinfacht — *One or All Problem* als früheste Verb-Philosophie
> Das Buch erschien 1998 und ist ein wichtiges frühes Werk zur Verb-Philosophie. Aber es war nicht Zhaos erstes Buch — das war *On Possible Life* (1994). Richtig ist: *One or All Problem* ist der erste Text, in dem Verb-Denken explizit zum Hauptthema wird. Quelle: [Zhao Tingyang — Berggruen Institute](https://www.berggruen.org/people/zhao-tingyang/)

> [!warning] Vereinfacht — „50% Nomen, 25% Mathematik, 25% Verb-Denken"
...
- Zhao Tingyang: [*One or All Problem* (1998)](https://www.genialokal.de/Suche/?q=zhao+tingyang+one+all+problem) — Früheste Version des Verb-Denken-Projekts
- Zhao Tingyang: [*Alles unter dem Himmel* (Suhrkamp, 2020)](https://www.genialokal.de/Suche/?q=zhao+tingyang+alles+unter+dem+himmel)
- Zhao Tingyang: *Metaphysics on Verbs* (动词形而上学) — Hauptwerk zur Verb-Philosophie, bislang ohne deutsche Übersetzung

*Im Vortrag erwähnt:*
- Santa Fe Institute: [Complexity Science](https://www.santafe.edu) — Hintergrund zur Komplexitätswissenschaft
- Geoffrey Hinton: Zahlreiche aktuelle Vorträge zu KI-Risiken auf YouTube
- Leibniz, *Monadologie* — [Stanford Encyclopedia: Principle of Sufficient Reason](https://plato.stanford.edu/entries/sufficient-reason/)
