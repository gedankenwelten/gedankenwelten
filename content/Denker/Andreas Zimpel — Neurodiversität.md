...
> *„Menschliche Gehirne sind so verschieden wie Schneeflocken — von weitem sehen sie alle gleich aus. Von Nah betrachtet gleicht kein Gehirn dem anderen."*
...
Das macht es wissenschaftlich unmöglich, dass zwei Menschen — auch eineiige Zwillinge — dasselbe Gehirn haben. Dazu kommt: Das Gehirn ist ein hochsoziales Organ, das durch Umwelteinflüsse permanent geprägt wird.
...
**Das Experiment:** Tower of Hanoi — mit verbaler Interferenz (gleichzeitig sprechen). Reine Sprach-Denker werden blockiert. Bild-Denker kaum.
...
- **Benoît Mandelbrot** — erfand die fraktale Geometrie, weil er Gleichungen als Bilder sah
- **Temple Grandin** — stellt sich Tieranlagen dreidimensional vor, bevor sie sie baut
...
Die **Happy Study** mit über 200 Millionen Teilnehmer:innen zeigt: Der entscheidende Faktor für Bildungserfolg ist nicht Intelligenz, nicht Herkunft — es ist die **Selbsteinschätzung**.
...
> [!quote] Über Lernende
> *„Wenn ich Schüler:innen frage: Wie willst du das lernen? — sagen die: ganz normal. Erst im Dialog, im Ausprobieren, kann man diesen Lernweg finden."*
...
**Das Clown-Spiel:** 8 Körperteile, 6 Größen pro Teil → **1.679.616 verschiedene Clowns**. Die meisten sind mittelgroß — aber alle **sehen anders aus**. Die Gruppe der "Normalen" ist maximal heterogen.

> [!important] Mathematischer Beweis der Gleichheit
> Man kann mathematisch zeigen: Eine Person aus dem Autismus-Spektrum kann dir **ähnlicher sein** als jemand, der genauso "neurotypisch" gilt wie du. Die Normalverteilung verbirgt Diversität, sie zeigt sie nicht.
...
**Pablo Pineda:** Mann mit Trisomie 21. Abschlüsse in Pädagogik und Psychologie. Hält Vorträge über Sozialdarwinismus in vollen Hörsälen. Wollte geistig behindert sein, noch bevor er geboren wurde — hat es aber anders entschieden.
...
- **Messung via Neurofeedback:** ADHS-Personen bewegen Gegenstände am Bildschirm mit innerer Aufregung, Autismus-Personen mit innerer Entspannung.

### 5.2 Orientierendes Aufmerksamkeitssystem (aufmerksamkeitsumfang)

Neurotypisch: **4 Einheiten** simultan (konstant, bei Männern wie Frauen).
...
- Schimpansen zeigen es **nicht** (trotz 98% genetischer Übereinstimmung)
- Kinder mit Trisomie 21, die sich noch nicht im Spiegel erkennen, helfen spontan einer fremden Person
- Mädchen im Autismus-Spektrum legt Spielzeug nicht in die Hand der Mitarbeiterin — sondern **in deren Tasche**: konstruktive Lösung eines Übergabeproblems

> [!important] Menschen im Autismus wollen Kontakt
> Sie ziehen sich nicht zurück, weil sie kein Interesse an anderen haben. Sie ziehen sich zurück, wenn ihre Aufmerksamkeit überfordert wird. Das Sozialinteresse ist vorhanden — genauso wie bei allen anderen.
...
> *„IQ-Tests messen möglicherweise gar nicht Intelligenz, sondern unsere Fähigkeit zu erraten, was man von uns hören will."*
...
2. **Wirtschaftliche Verwertbarkeit** (Autismus = gutes Debugging) ist kein ethisches Argument — es ist eine Form der Ausbeutung. Menschen im Spektrum wollen Erziehungswissenschaften studieren, Biologie, Geschichte — nicht nur Informatik.
...
Mausfeld: Die Vorstellung einer homogenen Gesellschaft ist ein Herrschaftsinstrument. Zimpel: Die Normalverteilung erzeugt mathematisch die Illusion homogener Gruppen. Beide zeigen: Die Idee, Menschen in Kategorien zu pressen (normal/anormal, wir/die anderen), beruht auf einer aktiv produzierten Illusion — nicht auf Tatsachen.

### → [[Erich Fromm — Haben oder Sein]]

Fromm: Selbsteinschätzung als ehrlicher Blick auf das eigene Leben — statt der Maske des Zufriedenseins. Zimpel: Selbsteinschätzung ist der stärkste Faktor für Bildungserfolg. Beide betonen: Was von innen kommt, ist echter als äußere Bewertung.

### → [[Hartmut Rosa — Resonanz und Unverfügbarkeit]]

Rosas Mediopassiv (*„es hat mich berührt"*) und Zimpels Bild-Denken beschreiben denselben Prozess: Wissen und Erleben entstehen nicht durch Anstrengung, sondern durch Öffnung. Resonanz lässt sich nicht erzwingen — genauso wenig wie ein Bild-Denker durch Sprachlehre zum Begreifen gezwungen werden kann.

### → [[Vipassana — Zehn Tage]]

Goenkas Praxis: Beobachten, was wirklich da ist. Zimpels Forschung: Wahrnehmen, was Lernende wirklich erleben — nicht was man von ihnen erwartet. Beide betonen den Wert des genauen Hinschauens ohne Projektion.

---

## Weiterführend

- Zimpel: *Lasst unsere Kinder spielen* — sein Hauptwerk zur neurodiversitätssensiblen Pädagogik
- Temple Grandin: *Thinking in Pictures* — Bild-Denken aus der Innenperspektive
- Benoît Mandelbrot: *The Fractal Geometry of Nature*
- Pablo Pineda: Vortrag über Sozialdarwinismus (Universität Hamburg)
- Felix Warneken (Anthropologisches Institut Leipzig / Max-Planck-Institut): Forschung zum angeborenen Hilfsverhalten bei Kleinkindern
