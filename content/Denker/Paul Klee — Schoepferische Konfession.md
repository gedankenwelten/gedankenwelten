---
title: "Paul Klee — Schöpferische Konfession"
date: 19.07.2026
description: "Kunst gibt nicht das Sichtbare wieder, sondern macht sichtbar: Klees Credo von 1920 — und der Tag 1937, an dem man den Sichtbarmacher unsichtbar machen wollte."
...
![[assets/Paul-Klee-Schoepferische-Konfession-banner.jpg|1200]]

<details><summary>🎨</summary>

**Künstlerhand:** Paul Klee

**Warum:** Zum ersten Mal die Haussprache für ihren Urheber: Die Wanderung aus Abschnitt II als Banner — die eine Linie, die zu Brücke, Rad, Blitz, Spirale und Punktsaat wird. Die Note über den Text, gemalt in der Grammatik des Textes.

**Prompt:** Paul Klee style watercolor with delicate pen lines on rough paper: a small journey told as a line — a single wandering ink line travels left to right across soft watercolor color fields, becoming on its way a wavy river passage, an arched bridge, a zigzag lightning, a little wheel, a spiral curl, and a seed-field of scattered dots under faint stars; at the far right the line rises into a small sun circle. Earthy Klee palette of ochre, dusty rose, slate blue, moss green on warm cream. Playful Bauhaus geometry, childlike precision, no realistic faces, no photorealism, 1200x500 wide banner.
...
Quelle: [Schöpferische Konfession — Volltext auf Wikisource](https://de.wikisource.org/wiki/Sch%C3%B6pferische_Konfession:_Paul_Klee) (Tribüne der Kunst und Zeit XIII, Berlin 1920 · gemeinfrei, Klee † 1940 · im [[Opus/Gedankenwelten/Primaertexte-RAG|Primärtexte-RAG]] als Volltext durchsuchbar)
...
>
> Wichtigste Schriften: *Schöpferische Konfession* (1920), *Pädagogisches Skizzenbuch* (1925), *Tagebücher 1898–1918*, *Das bildnerische Denken* (postum)
> Kernkonzepte: Sichtbarmachen statt Abbilden, Bewegung als Genesis, Kunst als Gleichnis der Schöpfung
>
> → [[DenkerVita/Paul Klee|DenkerVita]]
...
Die bittere Ironie liegt offen: Ein Text, der das Böse als „am Ganzen mitschaffende Kraft" denken wollte, traf auf ein Regime, das diese Reife nicht besaß — das Böse trat doch als „triumphierender Feind" auf. Und doch behielt der Text recht, nur langsamer: Die Ausstellung, die die Moderne vernichten sollte, wurde ungewollt ihr Katalog; die verspotteten Bilder hängen heute in München und New York, und die Namen der Spötter kennt niemand mehr. Der Krieg um die Erinnerung — die [[Arolsen Archives — Wie Rechtsextreme Geschichte umdeuten|Schwester-Note dieses Tages]] beschreibt seine heutige Front — ging in diesem Fall an die Verfemten.
...
> Quelle: [MoMA — Provenienz Twittering Machine](https://www.moma.org/collection/works/37347)

> [!success] Bestätigt — Text und Edition
...
> Quelle: [Wikisource — Schöpferische Konfession](https://de.wikisource.org/wiki/Sch%C3%B6pferische_Konfession:_Paul_Klee)

---

## Weiterführende Quellen

- [Schöpferische Konfession — Volltext (Wikisource)](https://de.wikisource.org/wiki/Sch%C3%B6pferische_Konfession:_Paul_Klee) — die Primärquelle dieser Note
- [Zentrum Paul Klee, Bern](https://www.zpk.org/) — Nachlass, ~4.000 Werke
- [MoMA — Die Zwitscher-Maschine](https://www.moma.org/collection/works/37347) — Werk und vollständige Provenienz
- [V&A — das NS-Inventar der „Entartete Kunst"-Beschlagnahmungen](https://www.vam.ac.uk/articles/entartete-kunst-the-nazis-inventory-of-degenerate-art)
- [bpb — Die Ausstellung „Entartete Kunst" in München](https://www.bpb.de/kurz-knapp/hintergrund-aktuell/252374/die-ausstellung-entartete-kunst-in-muenchen/)
...
### → [[Denker/Robert Musil — Die Verwirrungen des Zoeglings Toerless|Robert Musil — Die Verwirrungen des Zöglings Törleß]]
