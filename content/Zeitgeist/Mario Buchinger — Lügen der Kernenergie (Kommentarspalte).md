---
title: "Mario Buchinger — Lügen der Kernenergie: Kommentarspalte"
tags:
  - zeitgeist
  - kernenergie
  - klimapolitik
  ...
  - year-2024
aliases:
  - Buchinger Kernenergie Kommentarspalte
  - Lügen Kernenergie Kommentare
---
...
Transkript: `Gedankenwelten/Transkripte/Buchinger_Kernenergie_Kommentarspalte_Transkript.txt`
...
> [!quote] Abschluss-Kommentar (Nutzer „Reiner Unsinn 828", der das letzte Wort bekommt)
...
| Muster | Beschreibung |
|---|---|
| **Faktenflucht** | Der Beitragsinhalt wird ignoriert, Gegenbehauptungen werden ohne Belege vorgebracht |
| **Faktenferne Renaissance-Narrativ** | Behauptung einer globalen AKW-Renaissance trotz gegenteiliger IEA-Daten |
| **Verwechslung von Absicht und Umsetzung** | Politische Erklärungen werden mit realisierten Projekten gleichgesetzt |
| **Kosten-Externalisierung ausgeblendet** | Staatliche Subventionen, Entsorgungskosten und Haftungsübernahme werden nicht in die Wirtschaftlichkeitsrechnung einbezogen |
| **Falsche Kausalitäten** | Hohe deutsche Strompreise werden Erneuerbaren zugeschrieben (richtig: Netzentgelte, Merit-Order) |
| **„Wir hätten die besten AKW"** | Nationalstolz als Argument für technische Überlegenheit |
| **Generationen-Egoismus** | Atommüll-Problem wird mit „ich bin dann tot" beiseitegeschoben |
| **KI-Kommentare ohne Quellenkritik** | KI-generierte Antworten aus Desinformationsquellen (Epoch Times, Vernunftkraft, EIKE) werden gepostet |

---

## Faktencheck

> [!success] Bestätigt: Frankreich importierte 2022 Strom — deutsche Kohle sprang ein
...
> [!success] Bestätigt: Deutschland produziert ~60 % Strom regenerativ
...
> [!success] Bestätigt: SMRs existieren nicht als Serienprodukt
...
> [!success] Bestätigt: IEA STEPS-Szenario zeigt sinkenden Nuklearanteil bis 2050
...
> [!success] Bestätigt: Atommüll-Zwischenlagerung kostet ~1 Mrd. € jährlich
...
> [!success] Bestätigt: Fraunhofer ISE Gestehungskosten Kernenergie 15–55 Cent/kWh
...
> [!success] Bestätigt: COP-28-Erklärung zur Kernkraft-Verdreifachung war Absichtserklärung, keine Umsetzung
...
> [!warning] Vereinfacht: „Kernenergie ist gesundheitsschädlich, Erneuerbare nicht"
...
> [!warning] Vereinfacht: Infraschall bei Windkraft „schon so oft widerlegt"
...
> [!warning] Vereinfacht: AKW laufen maximal ~55–60 Jahre
...
> [!danger] Falsch: „22 Staaten haben bei COP28 am Wochenende beschlossen..."
