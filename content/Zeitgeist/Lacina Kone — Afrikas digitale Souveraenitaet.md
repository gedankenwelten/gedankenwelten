---
title: "Lacina Koné — Afrikas digitale Souveränität"
date: 01.07.2026
description: "Digitale Souveränität ist nicht Abschottung, sondern das Recht, die Systeme mitzugestalten, die uns gestalten — und Afrika wartet nicht länger auf eine Einladung in die Zukunft."
...
> [!info] Anlass — Unabhängigkeitstag Ruanda
...
Quelle: [re:publica 26 — Lacina Koné: Writing Our Own History: The Path to Africa's Digital Sovereignty](https://www.youtube.com/watch?v=j4xfSWZ6EM8)
...
>
> → [[DenkerVita/Lacina Kone|DenkerVita]]

---

## Inhalt

![[assets/Kone_zwei_regionen_2_80.jpg|700]]

### Zwei Realitäten, eine Frage

[▶ 0:00](https://www.youtube.com/watch?v=j4xfSWZ6EM8&t=0) — Koné beginnt nicht mit einer Vision, sondern mit einem Gefälle. Afrika steuert rund 2 % der weltweiten KI-Trainingsdaten bei; Europa importiert etwa 80 % der Technologien, von denen es abhängt. Zwei Regionen, zwei sehr verschiedene Ausgangslagen — und doch eine gemeinsame Frage:
...
[▶ 2:22](https://www.youtube.com/watch?v=j4xfSWZ6EM8&t=142) — Koné ist präzise darin, was Smart Africa *nicht* ist:
...
[▶ 14:34](https://www.youtube.com/watch?v=j4xfSWZ6EM8&t=874) — Der historisch schärfste Moment. Koné zieht die Linie vom Kolonialismus zur Gegenwart:
...
[▶ 13:02](https://www.youtube.com/watch?v=j4xfSWZ6EM8&t=782) — Koné räumt mit dem Missverständnis auf, das den Begriff vergiftet:
...
![[assets/Kone_2000_sprachen.jpg|700]]

[▶ 16:53](https://www.youtube.com/watch?v=j4xfSWZ6EM8&t=1013) — Die dritte Säule verdichtet Koné zu seinem stärksten Bild. Über 2.000 Sprachen werden in Afrika gesprochen; die großen KI-Systeme funktionieren nur in einem Bruchteil davon. Das sei kein technisches Detail:
...
[▶ 11:31](https://www.youtube.com/watch?v=j4xfSWZ6EM8&t=691) — Für das Verhältnis zu Europa findet Koné ein Bild, das aus einem gemeinsamen Op-Ed mit der GIZ-Geschäftsführerin Anna Sophie Herken stammt:
...
> [!success] Bestätigt — Afrika ~2 % der KI-Trainingsdaten
> Afrika trägt nur rund 2 % der weltweiten KI-Trainingsdaten bei. Die Zahl ist eine viel zitierte Schätzung (je nach Abgrenzung kursieren auch niedrigere Werte für Afrika+Südamerika kombiniert), aber die Größenordnung und die Kernaussage — massive Unterrepräsentanz — sind belegt. Passt zu weiteren Kennziffern: <1 % der Rechenzentren, ~3 % des KI-Talentpools.
> Quelle: [GIZ — Africa's AI Revolution Needs Data](https://www.giz.de/en/regions/africa/african-union/news/africas-ai-revolution-needs-you-lets-build-it-data)

> [!success] Bestätigt — Europa importiert ~80 % seiner Technologie
> Die EU deckt über 80 % ihrer zentralen digitalen Produkte, Dienste, Infrastruktur und IP aus Nicht-EU-Ländern. Präzise gilt der Wert für *digitale* Technologien (nicht Technologie schlechthin) — in einem Vortrag über digitale Souveränität ist das genau der gemeinte Rahmen.
> Quelle: [Atlantic Council — Digital sovereignty in Europe](https://www.atlanticcouncil.org/in-depth-research-reports/report/digital-sovereignty-europes-declaration-of-independence/)

> [!success] Bestätigt — Konnektivität 38 % vs. 68 %
> 2024 nutzten nur 38 % der afrikanischen Bevölkerung das Internet — der weltweit niedrigste Wert — gegenüber einem globalen Schnitt von 68 %. Exakt die ITU-Zahlen.
> Quelle: [ITU Facts and Figures 2024 — Internet use](https://www.itu.int/itu-d/reports/statistics/2024/11/10/ff24-internet-use/)

> [!success] Bestätigt — Demografie 2050 und Jugend
> Bis 2050 wird mehr als jeder vierte Mensch weltweit Afrikaner sein (1960: 1 von 11). Über 60 % der Afrikaner sind heute unter 25 — Afrika hat die jüngste Bevölkerung der Welt.
> Quelle: [World Economic Forum — Over 60% of Africa's population is under 25](https://www.weforum.org/stories/2023/08/africa-youth-global-growth-digital-economy/)

> [!success] Bestätigt — 850 Mio. ohne Identitätsnachweis
> Rund 850 Millionen Menschen weltweit haben keinen offiziellen Identitätsnachweis (World Bank ID4D, Stand 2021; gesunken von ~1 Mrd. 2018). Über die Hälfte lebt in Subsahara-Afrika und Südasien.
> Quelle: [World Bank — 850 million people globally don't have ID](https://blogs.worldbank.org/en/digital-development/850-million-people-globally-dont-have-id-why-matters-and-what-we-can-do-about)

> [!success] Bestätigt — über 2.000 Sprachen
> In Afrika werden je nach Abgrenzung zwischen 1.250 und über 2.000 Sprachen gesprochen — rund ein Drittel aller Sprachen der Welt. „Über 2.000" ist die gängige, vertretbare Angabe.
> Quelle: [Wikipedia — Languages of Africa](https://en.wikipedia.org/wiki/Languages_of_Africa)

> [!success] Bestätigt — Mobile Money führend, ~1,4 Bio. USD
> 2025 flossen 1,4 Billionen US-Dollar durch Mobile-Money-Wallets in Subsahara-Afrika — rund zwei Drittel des globalen Transaktionswerts, nach Transaktionszahl sogar ~74 %. Der Sprecher-Wert „~70 %" liegt exakt im belegten Band; präzise bezieht sich die Zahl auf *Subsahara*-Afrika, nicht den ganzen Kontinent — inhaltlich unerheblich.
> Quelle: [GSMA — Global mobile money market hits $1.4tn](https://www.gsma.com/newsroom/press-release/maturing-global-mobile-money-market-hits-1-4tn-in-transaction-value/) · [Connecting Africa — $1.4T in sub-Saharan Africa 2025](https://www.connectingafrica.com/mobile-money/-1-4t-flowed-through-mobile-money-in-sub-saharan-africa-in-2025-gsma)

> [!success] Bestätigt — Smart Africa: 42+ Staaten, Single Digital Market 2030
> Smart Africa (gegr. 2013) ist eine Allianz von 42 Mitgliedstaaten (~1,2 Mrd. Menschen) plus 50+ Privatpartnern, mit dem erklärten Ziel eines Single African Digital Market bis 2030.
> Quelle: [Smart Africa — Transform Africa Summit 2025](https://smartafrica.org/transform-africa-summit-2025-conakry-becomes-the-epicenter-of-digital-cooperation-in-africa/)

> [!warning] Vereinfacht — Arzt-Dichte 1 : 20.000
> Der Kontrast ist real, aber beide Zahlen sind grob gerundet. Der afrikanische *Durchschnitt* liegt bei rund 1 Arzt pro 4.000–5.000 Menschen (World Bank/WHO); „1 : 20.000" trifft nur die am schlechtesten versorgten Länder und ländlichen Regionen, nicht den Kontinent. Umgekehrt hat Europa 3,5–6 Ärzte pro 1.000 — die Angabe „1 : 1.000" *unterschätzt* Europa und macht den wahren Abstand sogar kleiner, als er ist. Als rhetorische Illustration der Versorgungslücke tragfähig, als Statistik überzeichnet.
> Quelle: [Physicians per 1,000 — Sub-Saharan Africa, World Bank](https://data.worldbank.org/indicator/SH.MED.PHYS.ZS?locations=ZG) · [Visual Capitalist — Doctor density](https://www.visualcapitalist.com/mapped-highest-and-lowest-doctor-density-world/)

> [!warning] Vereinfacht — Bevölkerung 1960 ~200 Mio.
> Der Wachstumsbogen stimmt, die Basiszahl nicht ganz: 1980 (~482 Mio.) und 2025 (~1,4–1,55 Mrd.) passen; für 1960 nennen die UN-Daten aber ~284 Mio., nicht 200 Mio. Die Rundung nach unten lässt das ohnehin dramatische Wachstum noch etwas steiler wirken.
> Quelle: [Macrotrends — Africa Population 1950–2026](https://www.macrotrends.net/global-metrics/countries/afr/africa/population)
...
- [Session-Seite re:publica 26](https://re-publica.com/de/session/writing-our-own-history-path-africas-digital-sovereignty) — offizielle Programmseite des Vortrags
- [Lacina Koné bei re:publica](https://re-publica.com/user/26346) — Sprecherprofil
- Unterstützt von der [Stiftung Mercator](https://www.stiftung-mercator.de/)

*Im Vortrag erwähnt:*

- **Smart Africa** — kontinentale Allianz, Sitz Kigali ([smartafrica.org](https://smartafrica.org/))
- **AfCFTA Digital Trade Protocol** — Rahmen für grenzüberschreitenden Datenverkehr, digitale Identitäten, elektronische Zahlungen
- **Masakhane** — Forschungskollektiv für afrikanische Sprach-KI ([masakhane.io](https://www.masakhane.io/))
...
- [ITU — Measuring Digital Development, Facts and Figures 2024 (PDF)](https://www.itu.int/itu-d/reports/statistics/wp-content/uploads/sites/5/2024/11/2402588_1e_Measuring-digital-development-Facts-and-Figures-2024_v4.pdf) — Primärquelle zu Konnektivität, Stadt-Land-Gefälle, Gender-Gap
- [World Bank ID4D — Global Dataset](https://id4d.worldbank.org/global-dataset) — Rohdaten zur globalen Identitätslücke
- [GSMA — State of the Industry Report on Mobile Money](https://www.gsma.com/newsroom/press-release/mobile-money-surpasses-two-billion-registered-accounts-and-over-half-a-billion-monthly-active-users-globally/) — Afrikas Mobile-Money-Führung
- [McKinsey — Leading, not lagging: Africa's gen AI opportunity](https://www.mckinsey.com/capabilities/quantumblack/our-insights/leading-not-lagging-africas-gen-ai-opportunity) — Datenlücke, Talent, Infrastruktur
- [UNECA — Africa's Population Crosses 1.5 Billion](https://www.uneca.org/stories/(blog)-as-africa%E2%80%99s-population-crosses-1.5-billion,-the-demographic-window-is-opening-getting) — demografisches Fenster
...
### → [[Spuren/Zentral-oder-dezentral-die-Schicht-zwischen-Mensch-und-Wissen|Zentral oder dezentral — wer kontrolliert das Sprachmodell?]]
