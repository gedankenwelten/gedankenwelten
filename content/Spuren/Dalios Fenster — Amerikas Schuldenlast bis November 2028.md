---
title: "Dalios Fenster — Amerikas Schuldenlast bis November 2028"
date: 08.08.2026
tags:
  - spur
  - usa
...
![[assets/Dalios-Fenster-Amerikas-Schuldenlast-bis-November-2028-banner.jpg|1200]]

<details><summary>🎨</summary>

**Étienne-Jules Marey (graphische Methode)** — der Physiologe, der im 19. Jahrhundert als Erster Bewegung über die Zeit aufzeichnete: feine Nadelspuren auf berußtem Papier, Messtrommel, Zinnoberrot für die Marke. Diese Hand, weil sie die *lange Blende* ist, von der das Spuren-Playbook spricht — ein Einzelbild friert einen Moment, die Aufzeichnung macht die Bewegung sichtbar. Die fünf roten Linien sind die vorab registrierten Schwellen, gezogen und unverrückbar. Der helle senkrechte Streifen ist das Fenster, November 2026 bis November 2028. Und die Nadelspur läuft flach darunter hindurch, ohne eine einzige Schwelle zu berühren: der ehrliche Stand bei Eröffnung. Ein Instrument, das aufgebaut ist und jetzt wartet.

*Prompt:* A wide 1200x500 banner in the style of a 19th-century scientific recording plate — Étienne-Jules Marey's graphical method: fine ink traces on smoked paper, warm sepia and soot black with one thin vermilion accent, precise engraved labels reduced to abstract tick marks, instrument-maker's aesthetic, no photorealism, no people. The whole width is one continuous measured field ruled with faint horizontal baselines and regular vertical time divisions. Across it runs a single delicate recording stylus trace, drawn in soot black, wandering low and almost flat on the left. Five thin vermilion horizontal threshold lines are drawn across the upper portion of the field, ruled and permanent, each terminating in a small precise marker at the right edge — the trace has not reached any of them. A narrow vertical band of slightly lighter smoked paper marks off a defined window in the middle-right of the field, its two edges ruled cleanly from top to bottom. At the far left a small brass recording drum and stylus arm, drawn in fine engraving lines. Everything is calm, exact, patient and unresolved — an instrument that has been set up and is now simply waiting. No text, no logos, no faces.
...
**Zum Datum** ([▶ 1:32](https://www.youtube.com/watch?v=Al0SLSS4vmw&t=92)): *„I think of a particularly vulnerable period is after the midterm elections and before the presidential election."* → Fenster: **03.11.2026 bis 07.11.2028**.

**Zur Reihenfolge** ([▶ 2:17](https://www.youtube.com/watch?v=Al0SLSS4vmw&t=137)): Zuerst steigen die langen Zinsen gegenüber den kurzen, während man versucht, die kurzen unten zu halten. Dann schwächt sich der Dollar ab. Dann bewegt sich Gold. Erst danach gerät der Aktienmarkt unter Druck, weil Anleihen relativ attraktiver werden. Die Notenbank kann das schwer steuern, weil es stagflationär wirkt.

**Zur Reaktion** ([▶ 4:35](https://www.youtube.com/watch?v=Al0SLSS4vmw&t=275)): finanzielle Repression — Renditen künstlich gedrückt, begleitet von höherer Besteuerung und höherer Inflation, im Extremfall Devisenkontrollen.
...
| Größe | Wert | Datum | Quelle |
|---|---|---|---|
| US-Staatsschulden gesamt | **39,89 Bio. USD** | 06.08.2026 | [Treasury, Debt to the Penny](https://fiscaldata.treasury.gov/datasets/debt-to-the-penny/debt-to-the-penny) |
| Rendite 10-jähriger US-Anleihen | **4,69 %** | 06.08.2026 | [FRED DGS10](https://fred.stlouisfed.org/series/DGS10) |
| Rendite 2-jähriger US-Anleihen | **4,25 %** | 06.08.2026 | [FRED DGS2](https://fred.stlouisfed.org/series/DGS2) |
| Zinsstruktur 10J − 2J | **+0,46 pp** | 07.08.2026 | [FRED T10Y2Y](https://fred.stlouisfed.org/series/T10Y2Y) |
| Dollar-Index (breit, handelsgewichtet) | **119,70** | 31.07.2026 | [FRED DTWEXBGS](https://fred.stlouisfed.org/series/DTWEXBGS) |
| Gold je Feinunze | **4.399,70 USD** | 08.08.2026 | Terminkurs COMEX |
| Haushaltsdefizit (Ist FY2025) | **5,9 % des BIP** | FY2025 | [CBO Monthly Budget Review](https://www.cbo.gov/publication/61307) |
| Haushaltsdefizit (Projektion FY2026) | **5,8 % des BIP** | 2026 | [CBO Budget and Economic Outlook 2026–2036](https://www.cbo.gov/publication/62105) |

> [!note] Was daran sofort auffällt
...
> [!note] Eine Schwelle noch am Eröffnungstag korrigiert
...
> [!warning] Die eingebaute Schwäche dieser Spur
...
| Ring | Wen sampeln | Bias-Flag |
|---|---|---|
| USA — staatsnah | Fed-Protokolle, Treasury-Statements, CBO | offizielle Linie, institutionelles Interesse an Ruhe |
| USA — unabhängig | Bloomberg, FT, kritische Ökonomen beider Lager | Marktnähe, teils Positionsinteresse |
| Europa | EZB, Bundesbank, europäische Finanzpresse | Interesse am Fortbestand des Dollarsystems |
| Mächte mit Einsatz | China (Devisenreserven), Japan (größter Auslandsgläubiger), Golfstaaten | je eigenes Interesse an Auf- oder Abwertung |
| Globaler Süden / Blockfreie | BRICS-Debatte, indische und brasilianische Wirtschaftspresse, afrikanische Zentralbanken | die systematisch überhörte Perspektive auf die Dollar-Abhängigkeit — hier liegt der eigentliche Mehrwert |

---

## Verbindungen

### → [[Denker/Ray Dalio — Der grosse Zyklus und die Rechnung Amerikas]]
...
- [Ray Dalio on US Debt, AI Bubble, Bond Markets](https://www.youtube.com/watch?v=Al0SLSS4vmw) — Bloomberg Television, Forbes Iconoclast Summit New York, 03.06.2026 — die Primärquelle der These
- [How Countries Go Broke: The Big Cycle](https://www.youtube.com/watch?v=2pa0trbk_no) — Dalio liest Kapitel 8 seines Buchs, 05.06.2025 — das Modell dahinter
